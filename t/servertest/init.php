...
{
    global $OUT_TMP;
    run("killall -9 dklab_realplexor 2>/dev/null");
...
function add_prefix($s, $prefix)
{
    return preg_replace('/[ \r]+$/m', '', preg_replace('/^/m', "$prefix ", $s));
}
